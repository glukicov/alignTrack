...
fit_count = 10000 # Number of times to run fit
...
for track_count in track_counts:
    ...
    # List to contain alignment errors for all degrees of freedom.
    ...
    for deg_freedom in alignment_errors:
        ...
        chi_bin_conts, chi_bin_edges, chi_patches = plt.hist(chi_squared_vals[deg_freedom], bins=20, label='Calculated Chi-Squared', color='blue')
