...
plt.legend(loc='upper left', title="Misalignment")
plt.text(130, 50, "Entries X: "+str(len(MisX))+"\nMean X: "+str(round(np.mean(MisX),3))+"\nSD X: "+str(round(np.std(MisX),3)), bbox=dict(facecolor='green', alpha=0.5), fontsize="6")
plt.text(130, 10, "Entries Y: "+str(len(MisY))+"\nMean Y: "+str(round(np.mean(MisY),3))+"\nSD Y: "+str(round(np.std(MisY),3)), bbox=dict(facecolor='red', alpha=0.5), fontsize="6")
