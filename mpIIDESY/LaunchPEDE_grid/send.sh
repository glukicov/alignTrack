jobsub_submit -N 1100 -G gm2 file:///gm2/app/users/glukicov/submitGridJobs/grid_submit.sh --expected-lifetime=1h --memory=500MB --disk=2GB --resource-provides=usage_model=OFFSITE --role=Analysis
