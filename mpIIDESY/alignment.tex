...
\begin{equation}
DLC_1 = \frac{\partial R}{\partial x_L}  
\end{equation}
...
\end{equation}
where \textbf{W} and \textbf{T} are the points of closest approach between the wire and the track, respectively. With vector $\bf{WT}$ perpendicular to both the wire and the track. 

In order to form the required derivatives w.r.t local and global parameters, we need a functional form of DCA expressed in term of the reconstructed track parameters and the position of the straw as well as its gradient? 
\begin{equation}
