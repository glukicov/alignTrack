...
\end{equation}
where $\textbf{d}=W_0 -T_0 =\begin{pmatrix}x_W - x_T\\y_W - x_T\\z_W - z_T\\\end{pmatrix}$, with $W_0$ and $T_0$ being some points on the wire and the track, respectively.
...
Let's first consider the bigger picture before attempting to calculate the derivatives! 
