...
class Tracker {
 ...
 private:
	...
	static const int trackCount=2000; /** Number of tracks to be simulated passing through detector */
	...
	float resolution; //TODO decide if this is a constant  [assigned value in the constructor]
 ...
 public:
	...
	static Tracker* instance(); // Function to return pointer to class instance

	LineData MC(float, std::ofstream&, std::ofstream&, std::ofstream&, bool); // Function to simulate a track through the detector, then return data for plane hits. 
