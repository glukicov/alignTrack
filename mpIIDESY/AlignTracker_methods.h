...
class Tracker {
 ...
 private:
    ...
    float dispX[8] = {0.0, 0.05, 0.1, -0.045, -0.03, 0.0, 0.0, 0.0}; // manual misalignment [relative misalignment per module]
 ...
 public:
	...
	ResidualData GetResiduals(std::vector<float>, std::ofstream&, bool);
