...
for i in range(0, n):
    #print('subDirs.push_back(Form("/vertices/station%02d/_'+str(int(valueRange[i]))+"_"+str(int(valueRange[i+1]))+'", stationNum));' )
    print( int ( ( int(valueRange[i])+int(valueRange[i+1]) ) / 2 ) )
