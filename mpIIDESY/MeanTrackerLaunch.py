...
###### New Fixed Offsets #######
offsets = () #M82F M1,3,5,7 +10um
offsets = () #M82F M1,3,5,7 -10um
offsets = () #M82F Odd:+10um Even: -10um

offsets = () #M8All M1,3,5,7 -10um
offsets = () #M8All M1,3,5,7 -10um
offsets = () #M8All Odd:+10um Even:
...
#offsets = (0.068, -0.088, -0.085, 0.056, 0.163, 0.123, -0.01, 0.046) #Mean X Case C (Run 3)
offsets = (0.053, -0.085, -0.071, 0.077, 0.186, 0.14, 0.001, 0.044) #Mean X Case C (Run 3)

# print "Offsets Run 3 [mm]: ", offsets
# raw_input("Offsets :: Run 3 correct? [press enter]") 
# #----------------------------
...
for i_module in range(0, 8):
	...
	recoYMean.append(meanY/lineN+(offsetsY[i_module])*1e3)
