...
##::::: X only::::
# T_mis_C = (0.1, 0.05, -0.1, 0.0, -0.07, 0.0, 0.05, 0.0) # Case A (X only :: Run 0)
# offsets = (0.028, -0.033, -0.184, -0.08, -0.139, -0.05, 0.026, -0.008) # Mean M82F Case A (Run 1)


# T_mis_C=(-0.2, 0.08, 0.2, -0.25, 0.15, 0.1, 0.2, -0.06) # Case B (X only)

## Y only
# expectPars = (12, 22, 32, 42, 52, 62, 72, 82) # X Only 
# T_mis_C=(0.1, 0.15, -0.1, 0.3, 0.2, -0.25, 0.07, 0.06) # Case B (Initial)
...
###### New Random Offsets #######
# offsets=(0.024, 0.046, -0.043, -0.029, -0.173, -0.227, -0.061, -0.102, -0.152, 0.029, -0.045, -0.066, 0.042, 0.012, 0.005, -0.025) # M82F new 10
# offsets=(0.023, 0.083, -0.069, -0.048, -0.209, -0.248, -0.08, -0.036, -0.166, 0.026, -0.038, -0.071, 0.053, 0.004, -0.018, -0.016) # M82F new 20
# offsets=( -0.001, 0.045, -0.032, -0.034, -0.149, -0.231, -0.046, -0.091, -0.069, 0.035, -0.012, -0.068, 0.048, 0.006, 0.009, -0.045) # M82F new 10_Run2

#offsets=(-0.188, -0.025, 0.114, 0.028, 0.227, -0.206, -0.226, 0.196, 0.15, 0.094, 0.069, -0.326, 0.161, -0.014, -0.144, 0.018) #M8A new 10
#offsets=(-0.141, -0.009, 0.118, 0.006, 0.278, -0.196, -0.22, 0.193, 0.143, 0.111, 0.074, -0.37, 0.154, 0.004, -0.138, -0.003) #M8A new 20
#offsets =  (-0.2, -0.006, 0.112, 0.031, 0.239, -0.207, -0.213, 0.192, 0.155, 0.142, 0.113, -0.307, 0.152, 0.001, -0.147, 0.001) #M8A new 10_Run2


# ###### New Fixed Offsets #######
#offsets = ( 0.028, 0.052, -0.034, -0.034, -0.173, -0.23, -0.077, -0.09, -0.126, 0.03, -0.05, -0.064, 0.031, 0.024, -0.003, -0.029) #M82F M1,3,5,7 +10um X
# offsets = (0.018, 0.062, -0.034, -0.034, -0.183, -0.22, -0.077, -0.09, -0.136, 0.04, -0.05, -0.064, 0.021, 0.034, -0.003, -0.029) #M82F M1,3,5,7 +10um Y
# offsets = ( 0.008, 0.052, -0.034, -0.034, -0.193, -0.23, -0.077, -0.09, -0.146, 0.03, -0.05, -0.064, 0.011, 0.024, -0.003, -0.029) #M82F M1,3,5,7 -10um X 
# offsets = ( 0.018, 0.042, -0.034, -0.034, -0.183, -0.24, -0.077, -0.09, -0.136, 0.02, -0.05, -0.064, 0.021, 0.014, -0.003, -0.029) #M82F M1,3,5,7 -10um Y 
# offsets = (0.008, 0.052, -0.024, -0.034, -0.193, -0.23, -0.067, -0.09, -0.146, 0.03, -0.04, -0.064, 0.011, 0.024, 0.007, -0.029) #M82F Odd:-10um Even: +10um X 
# offsets = (0.018, 0.042, -0.034, -0.024, -0.183, -0.24, -0.077, -0.08, -0.136, 0.02, -0.05, -0.054, 0.021, 0.014, -0.003, -0.019) #M82F Odd:-10um Even: +10um Y  

# offsets = (0.028, 0.052, -0.024, -0.034, -0.173, -0.23, -0.067, -0.09, -0.126, 0.03, -0.04, -0.064, 0.031, 0.024, 0.007, -0.029) #M82F M1-8: + 10 um X
# offsets = ( 0.008, 0.052, -0.044, -0.034, -0.193, -0.23, -0.087, -0.09, -0.146, 0.03, -0.06, -0.064, 0.011, 0.024, -0.013, -0.029) #M82F M1-8: - 10 um X
# offsets = (0.018, 0.062, -0.034, -0.024, -0.183, -0.22, -0.077, -0.08, -0.136, 0.04, -0.05, -0.054, 0.021, 0.034, -0.003, -0.019) #M82F M1-8: + 10 um Y
# offsets = (0.018, 0.042, -0.034, -0.044, -0.183, -0.24, -0.077, -0.1, -0.136, 0.02, -0.05, -0.074, 0.021, 0.014, -0.003, -0.039) #M82F M1-8: - 10 um Y
# offsets = (0.028, 0.062, -0.024, -0.024, -0.173, -0.22, -0.067, -0.08, -0.126, 0.04, -0.04, -0.054, 0.031, 0.034, 0.007, -0.019) #M82F M1-8: + 10 um XY
# offsets = (0.008, 0.042, -0.044, -0.044, -0.193, -0.24, -0.087, -0.1, -0.146, 0.02, -0.06, -0.074, 0.011, 0.014, -0.013, -0.039) #M82F M1-8: - 10 um XY


# offsets = ( -0.155, -0.031, 0.118, 0.026, 0.245, -0.208, -0.226, 0.198, 0.164, 0.105, 0.08, -0.331, 0.158, 0.0, -0.148, 0.001) #M8All M1,3,5,7 +10um X 
# offsets = (-0.165, -0.021, 0.118, 0.026, 0.235, -0.198, -0.226, 0.198, 0.154, 0.115, 0.08, -0.331, 0.148, 0.01, -0.148, 0.001) #M8All M1,3,5,7 +10um Y 
# offsets = (-0.175, -0.041, 0.118, 0.026, 0.225, -0.218, -0.226, 0.198, 0.144, 0.095, 0.08, -0.331, 0.138, -0.01, -0.148, 0.001) #M8All M1,3,5,7 -10um X
# offsets = ( -0.165, -0.041, 0.118, 0.026, 0.235, -0.218, -0.226, 0.198, 0.154, 0.095, 0.08, -0.331, 0.148, -0.01, -0.148, 0.001) #M8All M1,3,5,7 -10um Y
# offsets = (-0.175, -0.031, 0.128, 0.026, 0.225, -0.208, -0.216, 0.198, 0.144, 0.105, 0.09, -0.331, 0.138, 0.0, -0.138, 0.001) #M8All Odd:-10um Even: +10um X 
offsets = ( -0.165, -0.041, 0.118, 0.036, 0.235, -0.218, -0.226, 0.208, 0.154, 0.095, 0.08, -0.321, 0.148, -0.01, -0.148, 0.011) #M8All Odd:-10um Even: +10um X 

# offsets = (-0.155, -0.031, 0.128, 0.026, 0.245, -0.208, -0.216, 0.198, 0.164, 0.105, 0.09, -0.331, 0.158, 0.0, -0.138, 0.00) #M8All M1-8: + 10 um X
# offsets = (-0.175, -0.031, 0.108, 0.026, 0.225, -0.208, -0.236, 0.198, 0.144, 0.105, 0.07, -0.331, 0.138, 0.0, -0.158, 0.001) #M8All M1-8: - 10 um X
# offsets = (-0.165, -0.021, 0.118, 0.036, 0.235, -0.198, -0.226, 0.208, 0.154, 0.115, 0.08, -0.321, 0.148, 0.01, -0.148, 0.01) #M8All M1-8: + 10 um Y
# offsets = ( -0.165, -0.041, 0.118, 0.016, 0.235, -0.218, -0.226, 0.188, 0.154, 0.095, 0.08, -0.341, 0.148, -0.01, -0.148, -0.009) #M8All M1-8: - 10 um Y
# offsets = (-0.155, -0.021, 0.128, 0.036, 0.245, -0.198, -0.216, 0.208, 0.164, 0.115, 0.09, -0.321, 0.158, 0.01, -0.138, 0.011) #M8All M1-8: + 10 um XY
# offsets = ( -0.175, -0.041, 0.108, 0.016, 0.225, -0.218, -0.236, 0.188, 0.144, 0.095, 0.07, -0.341, 0.138, -0.01, -0.158, -0.009) #M8All M1-8: - 10 um XY

#::::: Y only::::
# offsets = (-0.031, 0.026, -0.208, 0.198, 0.105, -0.331, -0.0, 0.001)
