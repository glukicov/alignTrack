...
sub_directory = directory + smear_string + "_" + straw_string + "_" + str(track_count) + "_track_" + str(fit_count) + "_fit/"

# Create directory if doesn't already exist
if not os.path.exists(sub_directory):
    os.makedirs(sub_directory)
    print ""
    print "Created Directory at:", sub_directory
...
for deg_freedom in alignment_errors:
    ...
    file_name_prefixes = sub_directory + str(deg_freedom) + "_dof_"
...
# Save plot
file_name_prefixes = sub_directory + "all_dof_"
plt.savefig(file_name_prefixes + "align.pdf", format = "pdf")
plt.clf()
