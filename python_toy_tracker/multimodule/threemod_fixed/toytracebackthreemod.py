...
class Detector:    
    ...
    def get_wires_x(self):
        ...
        return self.module_1.get_wires_x() + self.module_2.get_wires_x() + self.module_3.get_wires_x()
    
    def get_wires_y(self):
        # Returns y-pos of all wires in detector
        return self.module_1.get_wires_y() + self.module_2.get_wires_y() + self.module_3.get_wires_y()
