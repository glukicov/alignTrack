...
class Detector:    
    ...
    def __init__(self, smearing=True, verbose=False, finite_straws=True):
        ...
        self.module_3 = Module(0, 324.7, 0, 0)
        self.module_4 = Module(0, 462.05, 0, 0)
        self.module_5 = Module(0, 599.4, 0, 0)
        self.module_6 = Module(0, 736.75, 0, 0)
    ...
    def get_wires_x(self):
        ...
        return self.module_1.get_wires_x() + self.module_2.get_wires_x() + self.module_3.get_wires_x() + self.module_4.get_wires_x() + self.module_5.get_wires_x() + self.module_6.get_wires_x()
    
    def get_wires_y(self):
        # Returns y-pos of all wires in detector
        return self.module_1.get_wires_y() + self.module_2.get_wires_y() + self.module_3.get_wires_y() + self.module_4.get_wires_y() + self.module_5.get_wires_y() + self.module_6.get_wires_y()
    ...
    def get_module(self, module_num):
        ...
        if module_num == 1:
            ...
            return self.module_3
        elif module_num == 4:
            return self.module_4
        elif module_num == 5:
            return self.module_5
        elif module_num == 6:
            return self.module_6
    ...
    def set_module_x_align(self, module_num, align_dist):
        ...
        if module_num == 1:
            ...
            self.module_3.set_x_align(align_dist)
        elif module_num == 4:
            self.module_4.set_x_align(align_dist)
        elif module_num == 5:
            self.module_5.set_x_align(align_dist)
        elif module_num == 6:
            self.module_6.set_x_align(align_dist)
