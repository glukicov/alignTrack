...
argv = sys.argv[1:]
try:
    opts, args = getopt.getopt(argv, "h:i:t:o:m:f:r:", ["help", "input_dir=", "track_count=", "output_dir=", "missing_straws=", "fits_attempted=", "hit_resolution="])
except getopt.GetoptError:
    print "tree_reader.py -i <input_dir> -t <track_count> -f <fit_count> -c <chi_sq_cut> -o <output_dir> -m <missing_straws> -r <hit_resolution>"
    sys.exit(2)
...
for opt, arg in opts:
    ...
    if opt in ("-h", "--help"):
        print "tree_reader.py -i <input_dir> -t <track_count> -c <chi_sq_cut> -o <output_dir> -r <hit_resolution>"
        sys.exit()
